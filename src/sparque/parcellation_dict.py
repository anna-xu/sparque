...
parc_file = [
    'datasets/volume_parcellations/schaefer400_resampled_myconnectome.nii.gz',
    'datasets/volume_parcellations/gordon333_resampled_myconnectome.nii.gz',
    'datasets/volume_parcellations/glasser360_resampled_myconnectome.nii.gz',
]

# file names of parcellations in surface space
surface_files_L = [
    'DCBC/parcellations/Schaefer2018_7Networks_400.32k.L.label.gii',
    'DCBC/parcellations/Gordon.32k.L.label.gii',
    'DCBC/parcellations/Glasser_2016.32k.L.label.gii',
]

surface_files_R = [
    'DCBC/parcellations/Schaefer2018_7Networks_400.32k.R.label.gii',
    'DCBC/parcellations/Gordon.32k.R.label.gii',
